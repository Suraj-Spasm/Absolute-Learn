...
public class UpdateUSer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int User_id = Integer.parseInt(request.getParameter("txtid"));
            String nm = request.getParameter("txtnm");
            String em = request.getParameter("txteml");
            String ct = request.getParameter("txtcntd");
            
            User u = udi.getUserByID(User_id);
            u.setUser_name(nm);
            u.setEmail(em);
            u.setContact(ct);
            boolean b = udi.updateUser(u);
            if (b) {
                out.println("User info Updated");
            } else {
